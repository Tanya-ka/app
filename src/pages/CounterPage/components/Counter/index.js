...
const Counter = ({countValue, handleIncrement, handleDecrement, handleReset, parityType}) => {
    return (
        <div className={styles.wrapper} style={{backgroundColor: countValue % 2 ===0 ? 'pink' : 'violet'}}>
            ...
            <div className={styles.controlButtons}>
                ...
                <button className={styles.controlButtonCenter} onClick={handleReset}>Reset</button>
